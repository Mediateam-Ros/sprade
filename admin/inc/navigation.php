                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                      ...
                      <li class="nav-item">
                          <a href="./?page=spieltag" class="nav-link nav-index">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Übersicht</p>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a href="./?page=spieltag/teamvergleich" class="nav-link nav-deposit">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Teamvergleich</p>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a href="./?page=spieltag/topscorer" class="nav-link nav-withdraw">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Topscorer</p>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a href="./?page=spieltag/torwartvergleich" class="nav-link nav-transfer">
                            <i class="far fa-circle nav-icon"></i>
